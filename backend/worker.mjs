...
async function receiptsFetch(request, env, ctx, originalFetch) {
  const url = new URL(request.url);
...
export default { fetch(request, env, ctx) { return receiptsFetch(request, env, ctx, originalWorker.fetch.bind(originalWorker)); } };
